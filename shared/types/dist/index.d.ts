...
export declare enum PurchaseCategory {
    MERCADO = "mercado",
...
export type DomainEvent = WhatsAppMessageReceivedEvent | MessageClassifiedEvent | PurchaseCreatedEvent | ClassificationFailedEvent;
